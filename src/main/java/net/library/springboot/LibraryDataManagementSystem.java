...
public class LibraryDataManagementSystem{
	...
	public static void main(String[] args) {
		SpringApplication.run(LibraryDataManagementSystem.class, args);
	}

	/*
	* Adding default Values to DB
	* */
	@Bean
